...
public class AlgoritmosOrdenacao {
	...
	public static int verificaOrdenacao(int n, int [] vetor) {
		...
		if(n>0) {
			// se igual a 1 est� ordenado // se = 0 vazio
		}
		return 0;
	}
	...
	/* O m�todo � invocado atraves de chamada est�tica passando a c�pia da refer�ncia
	 * do vetor a ser ordenado como parametro e esse parametro  fazendo com que o objeto
	 * vetor seja ordenado, devido a serem referencias ao mesmo objeto, n�o � necess�rio
	 * retorno, pois na chamada do objeto, o mesmo j� estar� ordenado.
